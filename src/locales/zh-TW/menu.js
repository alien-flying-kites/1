export default {
  'menu.welcome': '歡迎',
  'menu.model-training': '模型訓練',
  'menu.model-training.create-project': '新建項目',
  'menu.model-training.project-detail': '項目詳情',
  'menu.model-tool': '訓練工具',
  'menu.create-project': '創建項目',
  'menu.project': '項目詳情',
  'menu.more-blocks': '更多區塊',
  'menu.home': '首頁',
  'menu.dataset': '數據集管理',
  'menu.add-dataset': '新增數據集',
  'menu.dataset-detail': '數據集詳情',
  'menu.dataset-img-list': '圖片列表',
  'menu.dataset-detail-folder': '文件夾列表',
  'menu.tag': '數據標注管理',
  'menu.add-tag': '新增標準',
  'menu.tag-detail': '標準詳情',
  'menu.login': '登錄',
